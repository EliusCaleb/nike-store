...
function Product({ id, color, shadow, title, text, img, btn, rating, price }) {
  return (
    <>
      <div className={` relative bg-gradient-to-b ${color} ${shadow} grid items-center justify-items-center rounded-xl px-5 py-4  transition-all duration-700 ease-in-out w-full hover:scale-105`}>
